...
public class sr_puesto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
             String opc=request.getParameter("btnGuardar");
            puesto = new Puesto(Integer.valueOf(request.getParameter("txt_id")),request.getParameter("txt_puesto"),Integer.valueOf(request.getParameter("drop_departamento")),request.getParameter("txt_fechaIngreso"),request.getParameter("txt_estado"));
        ...
        // Boton agregar 
            ...
            // Boton modificar 
            if ("modificar".equals(request.getParameter("btnGuardar"))){
