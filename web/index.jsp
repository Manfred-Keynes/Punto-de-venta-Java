...
<!--              <button name="btn_Ingresar" value="Ingresar" class="btn solid">Ingresar</button>-->
            ...
            <form id="formLogin" action="sr_login" method="post" class="sign-up-form">
              ...
              <div class="input-field">
                ...
                <input type="text" placeholder="Usuario" name="txt_name" required >
              </div>
              <div class="input-field">
                <i class="fas fa-lock"></i>
               
                <input type="password" placeholder="Contraseña" name="txt_password" id="txt_password" required>
              </div>
              <div class="input-field">
                <i class="fas fa-lock"></i>
                
                <input type="password" placeholder="Contraseña" name="txt_password2" id="txt_password2" required>
              </div>
