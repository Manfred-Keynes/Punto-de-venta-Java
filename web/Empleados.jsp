...
<html>
    ...
    <body class="main">
        <div class="mt-4">
            <h1 class=" mb-4" >Mantenimiento de Empleados</h1>
            <div class=" container mb-5">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_empleados" onclick="limpiar()"><i class="fa-solid fa-plus"></i> Agregar empleado</button>
            </div>
        </div>
        <div class="container">
            <!-- Modal -->
