...
<body class="main">
    ...
    <div class="container content-tbl">
        ...
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modal_clientes" onclick="limpiar()" ><i class="fa-solid fa-plus"></i> Nuevo Cliente</button> 
