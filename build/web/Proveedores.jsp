...
<body class="main">
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_prove" onclick="limpiar()"><i class="fa-solid fa-plus"></i>Nuevo Proveedor</button>
